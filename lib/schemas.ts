...
export const TeamProjectSchema = z.object({
  title: z.string(),
  description: z.string(),
  status: z.string().default("In discovery"),
  owner: z.string().default("Team-owned"),
  timeline: z.string().default("This quarter"),
  problem: z.string().default("The team is still shaping the problem statement."),
...
export const TeamSchema = z.object({
  ...
  currentProjects: z.array(TeamProjectSchema),
